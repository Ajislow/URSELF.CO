...
session_start();
//koneksi ke database
$koneksi = new mysqli("localhost","root","","urself.co");
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    <img src="assets/img/kong1.jpg" class="user-image img-responsive"/>
					</li>
				
					
                    <li><a href="index.php"><i class="fa fa-home"></i> Home</a></li>
                    <li><a href="index.php?halaman=produk"><i class="fa fa-th-list"></i> Produk</a></li>
